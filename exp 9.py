...
# Read the image 
image = cv2.imread(r"C:\Users\shiva\OneDrive\Pictures\Screenshots\Screenshot 2026-04-09 103843.png")  # Replace with your image file 
...
# Display images cv2.imshow("Original Image", image) 
